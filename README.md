...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-morning-2942
```

A live public deployment of this template is available at [https://hidden-morning-2942.templates.workers.dev](https://hidden-morning-2942.templates.workers.dev)
